...
| 29.10.2018  | Charlotte | hands-on session #1: RNA-seq  | FASTQC/Salmon/etc. | [Capturing Heterogeneity in Gene Expression Studies by Surrogate Variable Analysis](https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.0030161) (MS, CR) | [Averaged gene expressions for regression](http://www.web.stanford.edu/~hastie/Papers/averaged_regression.pdf) (AS, LB, MK) |
