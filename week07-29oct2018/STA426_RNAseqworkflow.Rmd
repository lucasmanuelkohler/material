...
# data_dir <- "~/Dropbox/Teaching_material/STA426lecture2018/for_students_input"
## If you are running from the computers in Y01-F-50, use the following path:
...
## you have write permission. If you just want to read the pre-generated output, 
## it is the path to the unpacked STA426_2017_RNAseq_output folder
output_dir <- "~/Desktop/STA426_2018"
## If you are running from the computers in Y01-F-50 and only want to read
...
## For computers in Y01-F-50:
path_to_fastqc <- "/usr/local/miniconda3/bin/fastqc"

## HISAT2-build
# path_to_hisat2_build <- "~/Documents/Software/hisat2-2.0.4/hisat2-build"
## For computers in Y01-F-50:
path_to_hisat2_build <- "/usr/local/course/hisat2-2.0.4/hisat2-build"

## HISAT2
# path_to_hisat2 <- "~/Documents/Software/hisat2-2.0.4/hisat2"
## For computers in Y01-F-50:
path_to_hisat2 <- "/usr/local/course/hisat2-2.0.4/hisat2"

## samtools
# path_to_samtools <- "/usr/local/bin/samtools"
## For computers in Y01-F-50:
path_to_samtools <- "/usr/local/miniconda3/bin/samtools"
...
## For computers in Y01-F-50:
path_to_salmon <- "DYLD_FALLBACK_LIBRARY_PATH=/usr/local/miniconda3/lib /usr/local/miniconda3/bin/salmon"
```
